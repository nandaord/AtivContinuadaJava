...
import br.com.cesarschool.poo.titulos.testes.EntidadeTeste;
...
public class TesteGeral {
    ...
    protected <T extends Entidade> String obterNomeArquivo(T ent) {
        return obterNomeArquivo(NOME_DIR, ent);
    }
    protected <T extends Entidade> String obterNomeArquivo(String dir, T ent) {
