...
public class TesteRepositorioTransacao extends TesteGeral {
    ...
    public void testDAO01() {
        ...
        EntidadeOperadora eaC = new EntidadeOperadora(2, "EO1", true);
        EntidadeOperadora eaD = new EntidadeOperadora(3, "EO2", false);
    ...
    public void testDAO02() {
        ...
        EntidadeOperadora eaC = new EntidadeOperadora(5, "EO5", true);
        EntidadeOperadora eaD = new EntidadeOperadora(6, "EO6", false);
